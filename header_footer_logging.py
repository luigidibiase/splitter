# -*- coding: utf-8 -*-
"""
Created on Mon May 16 14:44:11 2022
...
# write start to log
#-----------------------------------------------------------------------------------------------#
logging.basicConfig(filename=f'{path}/log/logWithLoggin.log',
                    format='%(message)s',
                    filemode='w')
    ...
    # records
        ...
        if header_check_types:
            ...
            # if the record is a duplicate or the fields are not right       
                ...
                logger.info(f'In line {i}: DuplicateKeys:{duplicates_keys},' + 
...
# write end to log
#-----------------------------------------------------------------------------------------------#
logger.info(f'Process ended:{datetime.datetime.now()} \n' + 
              f'Duration: {datetime.datetime.now() - start}')        
